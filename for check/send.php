...
/*$files = $_FILES;
var_dump(empty($files['picture']));
var_dump(isset($files['picture']['name']));
var_dump($files['picture']);
var_dump($files['picture']['name']);
var_dump($files['picture']['full_path']);*/
var_dump($_POST);
    ...
    /*if (!empty($_FILES['picture']['name'])){
        ...
        if (move_uploaded_file($file['tmp_name'],'img/' . $file['name'])){
            var_dump($file['name'], $file['full_path']);
